...
# 이미지를 표시할 레이블 생성
image_label = tk.Label(window, text="버튼을 클릭하여 선수를 선택하세요.", compound=tk.CENTER)
